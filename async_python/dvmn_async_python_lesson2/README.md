...
Задача из модуля [Асинхронный Python](https://dvmn.org/modules/async-python) обучающего проекта [Devman](https://dvmn.org/).

Запуск программы:

`python main.py`

Для управления кораблём используйте стрелочки.